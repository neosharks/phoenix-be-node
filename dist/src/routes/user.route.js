...
userRoutes.post("/update", (0, checkRoleAuth_middleware_1.checkRoleAuth)(), s3upload_core_1.uploadFileMiddleware.single("profileImage"), user_controller_1.UserController.update);
